...
static void schnorr_sign_integration_only_generator();
static void schnorr_sign_integration_only_basepoint();
...
int main()
{
    ...
    schnorr_sign_integration_only_generator();
    schnorr_sign_integration_only_basepoint();
...
void schnorr_sign_integration()
{
    ...
    schnorr_keygen_from_basepoint_ZZZ(&public, &private, &basepoint, test_randomness);
    ...
    TEST_ASSERT(0 == schnorr_sign_ZZZ(&c, &s, &n, NULL, msg, msg_len, &generator, &basepoint, &public, private, NULL, 0, test_randomness));

    TEST_ASSERT(0 == schnorr_verify_ZZZ(c, s, n, NULL, msg, msg_len, &generator, &basepoint, &public, NULL, 0));

    printf("\tsuccess\n");
}

void schnorr_sign_integration_only_generator()
{
    printf("Starting schnorr::schnorr_sign_integration_only_generator...\n");
    ...
    schnorr_keygen_from_basepoint_ZZZ(&public, &private, &generator, test_randomness);
    ...
    TEST_ASSERT(0 == schnorr_sign_ZZZ(&c, &s, &n, NULL, msg, msg_len, &generator, &generator, &public, private, NULL, 0, test_randomness));

    TEST_ASSERT(0 == schnorr_verify_ZZZ(c, s, n, NULL, msg, msg_len, &generator, &generator, &public, NULL, 0));

    printf("\tsuccess\n");
}

void schnorr_sign_integration_only_basepoint()
{
    printf("Starting schnorr::schnorr_sign_integration_only_basepoint...\n");
    ...
    TEST_ASSERT(0 == schnorr_sign_ZZZ(&c, &s, &n, NULL, msg, msg_len, &basepoint, &basepoint, &public, private, NULL, 0, test_randomness));

    TEST_ASSERT(0 == schnorr_verify_ZZZ(c, s, n, NULL, msg, msg_len, &basepoint, &basepoint, &public, NULL, 0));
